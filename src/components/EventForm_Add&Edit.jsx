...
export const EventForm = ({ submitEvent, formMethod, ButtonText, formData, initialFormState }) => {
    ...
    const handleChange = (event) => {
        ...
        if (name === 'categoryIds') {
            ...
            formData = (values) => ({ ...values, [name]: catIds.sort() });
            setInputs(formData);
        }
        else {
            formData = (values) => ({ ...values, [name]: value });
            setInputs(formData);
        }
